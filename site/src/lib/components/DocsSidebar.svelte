  ...
  const nav = [
    ...
    },
    {
      ...
      sections: [
        ...
        { hash: 'smart-routing',  label: 'Smart routing' },
        { hash: 'r2',             label: 'Cloudflare R2' },
        { hash: 's3',             label: 'AWS S3' },
        { hash: 'minio',          label: 'MinIO' },
        { hash: 'dedup',          label: 'Deduplication' },
        { hash: 'gc',             label: 'GC & cleanup' },
        { hash: 'migration',      label: 'Migration' },
      ],
    },
    {
      href: `${base}/docs/cli`,
